...
namespace SyntaxRunner.Utils
{
    /// <summary>
    /// Class to test size of objects in memory
    /// From: https://github.com/CyberSaving/MemoryUsage/blob/master/Main/Program.cs
    /// </summary>
    /// <typeparam name="T">The object type being tested</typeparam>
    public static class TestSize<T>
    {
        public static int SizeOfObj(Type T, object thevalue)
        {
            var type = T;
            int returnval = 0;
            if (type.IsValueType)
