...
namespace Lists
{
    ...
    public class StringListTest
    {
        ...
        [TestMethod]
        public void StringListTest5()
        {
            StringList stringList = new StringList();
            int expectedMaxSize = 1024;
            int expectedNextIndexValue = 1000;
            int expectedCountOfCharacters = 2890;
            string expectedOutputString = "01234567891011121314151617181920212223242526272829303132333435363738394041424344" +
